...
export const portfolioData: Project[] = [
  {
    title: "Applytics",
    description:
      "An advanced data visualization platform for tracking job application conversion funnels and career growth metrics.",
  ...
  },
  {
    ...
    description:
      "A comprehensive educational platform and developer playground for mastering Tailwind CSS through interactive 3D UI visualizers.",
    techStack: [
      "Next.js",
      "TypeScript",
      "Tailwind v4",
    ...
    hardProblem:
      "Engineered a custom CSS-to-Tailwind mapping engine and real-time 3D UI visualizer for atomic CSS properties.",
    category: "DX/Tooling",
    links: {
      github: "https://github.com/AskTiba/Tailwind-Studio",
      live: "https://tailwind-studio-eight.vercel.app/",
    },
  },
  {
    title: "ChessFed-Ug",
    description:
      "The official national tournament and ranking platform for the Uganda Chess Federation, managing thousands of active players.",
    techStack: [
      "Next.js 15",
      "Prisma",
      "PostgreSQL",
  ...
  },
  {
    title: "Live-Orbit",
    description:
      "A mission-critical medical domain dashboard for real-time surgical status tracking and server-side document orchestration.",
    techStack: ["React", "Node.js", "Socket.io", "PDFKit", "Zustand"],
    seniorSignal: "Real-time & Mission-Critical Systems",
    hardProblem:
      "Achieved zero-latency state synchronization across distributed surgical boards and automated complex PDF report generation.",
    category: "Real-time",
    links: {
      github: "https://github.com/AskTiba/Live-Orbit",
      live: "https://live-orbit-theta.vercel.app/",
    },
  },

  {
    ...
    description:
      "A modern, high-performance typing speed test application featuring real-time WPM tracking and persistent personal bests.",
  ...
  },
  {
    title: "Weather-Now",
    description:
      "A high-fidelity weather application featuring geolocation-aware data fetching and dynamic, context-aware UI themes.",
  ...
  },
  {
    title: "Steward",
    description:
      "A multi-platform property management ecosystem sharing core business logic across web and mobile via a unified architecture.",
    techStack: [
      "React Native",
      "Expo",
      "React",
    ...
    hardProblem:
      "Orchestrated a complex TypeScript monorepo to share 90% of business logic across Web and React Native mobile platforms.",
    category: "Mobile",
    links: {
  ...
  },
  {
    title: "Worksy",
    description:
      "A collaborative workspace management platform for high-growth teams, built during the Chingu Engineering Residency.",
  ...
  },
  {
    title: "PullBoard",
    description:
      "A developer productivity tool for monitoring and managing GitHub pull requests across multiple enterprise repositories.",
    techStack: ["React", "GitHub API", "TypeScript", "Tailwind CSS"],
    seniorSignal: "Developer Tooling & API Integration",
    hardProblem:
      "Aggregated and normalized high-volume data from the GitHub API into a performant, real-time developer dashboard.",
    category: "DX/Tooling",
    links: {
      github: "https://github.com/AskTiba/PullBoard",
      live: "https://v57-tier3-team-33-frontend.onrender.com/",
    },
  },
];
